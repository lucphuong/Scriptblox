...
Dungoen = game.PlaceId == 73902483975735
Sea = World1 or World2 or World3 or Dungoen or plr:Kick("❌ Blox Fruits Only ❌")
Marines = function()
...
Tabs.Travel:AddButton({
    Title = "Travel Dungeon",
    Description = "Teleport to Dungeon",
    Callback = function()
        pcall(function()
            TeleportService:Teleport(DUNGEON_PLACE_ID, player)
        end)
    end
})
